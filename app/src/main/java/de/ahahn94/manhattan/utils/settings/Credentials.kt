...
data class Credentials(var username: String = "", var password: String = "", var apiKey: String = "") {
    ...
    companion object {
        ...
        private const val CREDENTIALS_PREFERENCES_NAME = "de.ahahn94.manhattan.credentials"
